---
name: remember
description: Explicitly save an insight, decision, or learning to mempalace's long-term storage. Use when the user says "remember this", "save this", or wants to preserve knowledge for future sessions.
...
Use the `memory_save` MCP tool to persist it.
...
If `memory_save` isn't available, the mempalace MCP shim didn't start — tell the user to:

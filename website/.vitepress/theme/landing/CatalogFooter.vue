  ...
  <footer v-pre class="catalog">
    ...
    <div class="catalog-card">
      ...
      <div>
        <h4>The project</h4>
        <ul>
          <li><a href="https://github.com/quangdang46/mempalace_rust">GitHub</a></li>
          <li><a href="https://github.com/quangdang46/mempalace_rust/blob/main/README.md">Readme</a></li>
          <li><a href="https://github.com/quangdang46/mempalace_rust/blob/main/ROADMAP.md">Roadmap</a></li>
          <li><a href="https://github.com/quangdang46/mempalace_rust/blob/main/CHANGELOG.md">Changelog</a></li>
        </ul>
      </div>
    </div>
  </footer>

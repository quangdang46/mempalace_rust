...
<pre><span class="prompt">$</span> cargo install --git https://github.com/quangdang46/mempalace_rust mempalace
<span class="c">Successfully installed mpr</span>
<span class="prompt">$</span> mpr init
...
<span class="prompt">$</span> mpr mine <span class="dim">./notes</span>
<span class="ok">  ✓</span> filed · <span class="c">W-001/R-01/D-001</span></pre>
    ...
    <div class="install-cta">
      ...
      <a href="https://github.com/quangdang46/mempalace_rust" class="btn">
